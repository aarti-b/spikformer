...
parser.add_argument('-data-dir', metavar='DIR',default="/home/otherLab/Arti/spikformer/spikformer/mnist/dataset/",
                    help='path to dataset')
parser.add_argument('--dataset', '-d', metavar='NAME', default='mnist',
...
class GrayscaleToRGB:
    def __call__(self, x):
        # Assuming x is a tensor returned by ToTensor()
